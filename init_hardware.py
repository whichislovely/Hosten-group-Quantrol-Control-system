...
class init_hardware(EnvExperiment):
    ...
    def run(self):
        ...
        self.ttl15.off()
        delay(10*ns)
        self.fastino0.set_dac(0, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(1, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(2, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(3, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(4, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(5, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(6, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(7, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(8, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(9, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(10, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(11, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(12, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(13, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(14, 0.0000)
        delay(10*ns)
        self.fastino0.set_dac(15, 0.0000)
