...
class init_hardware(EnvExperiment):
    ...
    def run(self):
        ...
        self.zotino0.write_dac(15, 1.000000)
        self.zotino0.load()
        ...
        self.urukul1_ch0.set(frequency = 20.0*MHz, amplitude = 1.0, phase = 0.0)
        self.urukul1_ch0.sw.on() 
        self.urukul1_ch1.set_att(0.0*dB) 
        self.urukul1_ch1.set(frequency = 20.0*MHz, amplitude = 1.0, phase = 0.0)
        ...
        self.urukul2_ch1.set_att(21.5*dB) 
