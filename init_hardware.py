...
class init_hardware(EnvExperiment):
    ...
    def run(self):
        ...
        self.mirny0_ch0.set_frequency(0.0*MHz)
        self.mirny0_ch0.sw.off() 
        self.mirny0_ch1.set_att(0.0*dB) 
        self.mirny0_ch1.set_frequency(0.0*MHz)
        self.mirny0_ch1.sw.off() 
        self.mirny0_ch2.set_att(0.0*dB) 
        self.mirny0_ch2.set_frequency(0.0*MHz)
        self.mirny0_ch2.sw.off() 
        self.mirny0_ch3.set_att(0.0*dB) 
        self.mirny0_ch3.set_frequency(0.0*MHz)
