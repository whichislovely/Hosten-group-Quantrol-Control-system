...
Frequency of the DDS should be within half of the reference clock due to Nyquist criteria. Shortly, it requires at least two samples per cycle to reconstruct a desired output waveform. For out setup with 1 GHz reference clock frequencies close to 400 MHz already show significant sidebands.
